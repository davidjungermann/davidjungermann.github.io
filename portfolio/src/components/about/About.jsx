    ...
    <div className="content">
      <div className="container">
        <div className="info-body">
          ...
          <p>
            As of January 2021, I will write my master thesis within Interaction
            Design at{" "}
            <b>
            ...
            <i>
              Introducing Pedagogics and Interactive UX in Documentation and
              Developer Tools
            </i>
            , where we will attempt to improve Homepal's developer tools and API
            documentation using UX and Interaction Design.
          </p>
          <p>
